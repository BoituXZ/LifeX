    ...
    <div className={styles.container}>
      ...
      <div className={styles.Body}>
        ...
        <div className={styles.tableContainer}>
          <PillTable pills={pills} />
          {showForm && <AddPills onAddPill={handleAddPill} />}
        </div>
